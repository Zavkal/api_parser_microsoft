...
def get_game_up_to(price: int) -> list[str]:
    result = []
...
def get_products_by_discount(min_percentage: float, max_percentage: float) -> list[str]:
